...
This project could be taken into a number of different directions. One future idea for continuing this project is determining how other factors (free agency, injuries, trades, etc.) would effect the different positions. Another future idea to continue this project is making comparisions using specific teams or leagues (AL or NL) separately. A final future idea for continuing this project is comparing players in different decades and determining who were the most effective players at their positions.
